...
knitr::kable(foc_vessels,
             align = "lll", 
             caption = "Global Fishing Watch Vessels with Flags of Convience",
...
peru_fishves_2021_sum <- peru_fishves_2021 %>% 
  ...
  summarise(n_foreign = sum(flag == "PER"), # how many peru flag observations
            n_all = length(flag), # how many total flag observations
            prop_foreign_all = n_foreign/n_all) # calculate prop
```
